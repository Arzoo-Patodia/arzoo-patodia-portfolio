...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function submitBooking() {
        ...
        const gCalUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent('1:1 Resume Review with Arzoo Patodia')}&dates=${activeYear}${monthNumStr}${dateNumStr}T100000Z/${activeYear}${monthNumStr}${dateNumStr}T103000Z&details=${encodeURIComponent('Google Meet Link: ' + meetUrl)}&location=${encodeURIComponent(meetUrl)}`;
