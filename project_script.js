...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Available Time Slots for 45 min project guidance (spaced 1h apart)
    const availableSlots = [
    ...
    function submitBooking() {
        ...
        const gCalUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent('Project Guidance Session with Arzoo Patodia')}&dates=${year}${monthNumStr}${dateNumStr}T100000Z/${year}${monthNumStr}${dateNumStr}T104500Z&details=${encodeURIComponent('Google Meet Link: ' + meetUrl)}&location=${encodeURIComponent(meetUrl)}`;
