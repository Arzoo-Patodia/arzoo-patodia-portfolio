...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function submitBooking() {
        ...
        const gCalUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent('1:1 Career Mentoring with Arzoo Patodia')}&dates=${year}${monthNumStr}${dateNumStr}T100000Z/${year}${monthNumStr}${dateNumStr}T103000Z&details=${encodeURIComponent('Google Meet Link: ' + meetUrl)}&location=${encodeURIComponent(meetUrl)}`;
