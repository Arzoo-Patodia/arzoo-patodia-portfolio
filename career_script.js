...
document.addEventListener('DOMContentLoaded', () => {
    ...
    function submitBooking() {
        ...
        const gCalUrl = `https://calendar.google.com/calendar/render?action=TEMPLATE&text=${encodeURIComponent('1:1 Career Mentoring with Arzoo Patodia')}&dates=202607${dateNumStr}T100000Z/202607${dateNumStr}T103000Z&details=${encodeURIComponent('Google Meet Link: ' + meetUrl)}&location=${encodeURIComponent(meetUrl)}`;

        // Dispatch automated email notification to Host (patodiaarzoo8@gmail.com) and Visitor
        sendBookingEmail('1:1 Career Mentoring', bookingData, dateStr, bookingData.time, meetUrl);
    ...
    function sendBookingEmail(serviceTitle, bookingData, dateStr, timeStr, meetUrl) {
        ...
        // 2. Webhook / Formspree Notification Dispatch
